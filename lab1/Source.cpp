	...
	while (1) {
		...
		else if (input_menu == 3)
		{
			...
			for (int i = 0; i < (read_num - 1); i++)
			{
				...
				{
					if (read[i].number > read[i + 1].number)
					{
						int read_i_num = read[i].num;
						read[i].num = read[i + 1].num;
						read[i + 1].num = read_i_num;
				...
				{
					if (read[i].position > read[i + 1].position)
					{
						int read_i_num = read[i].num;
						read[i].num = read[i + 1].num;
						read[i + 1].num = read_i_num;
		...
		else if (input_menu == 4)
		{
			...
			if (type_search == 1)
				{
					char last_name[100] = ""; cout << "Enter: "; cin >> last_name;
					system("cls");
					for (int i = 0; i < read_num; i++)
				...
				{
				char name[100] = ""; cout << "Enter: "; cin >> name;
				system("cls");
				for (int i = 0; i < read_num; i++)
			...
			{
				char patronymic[100] = ""; cout << "Enter: "; cin >> patronymic;
				system("cls");
				for (int i = 0; i < read_num; i++)
					if (!strcmp(patronymic, read[i].patronymic))
						output_read(read[i]);
				system("pause");
			}
			else if (type_search == 4)
			{
				int number; cout << "Enter: "; cin >> number;
				system("cls");
				for (int i = 0; i < read_num; i++)
					if (number==read[i].number)
						output_read(read[i]);
				system("pause");
			}
			else if (type_search == 5)
			{
				int position; cout << "Enter: "; cin >> position;
				system("cls");
				for (int i = 0; i < read_num; i++)
					if (position==read[i].position)
						output_read(read[i]);
				system("pause");
			}
			else if (type_search == 6)
			{
				int y_of_d; cout << "Enter: "; cin >> y_of_d;
				system("cls");
				for (int i = 0; i < read_num; i++)
					if (y_of_d==read[i].y_of_d)
						output_read(read[i]);
				system("pause");
			}
